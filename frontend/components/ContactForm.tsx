...
export default function ContactForm() {
  ...
  return (
    <section
      className="py-[86px] lg:py-24 bg-neutral-950 border-t border-white/5"
      id="contact"
    >
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-neutral-400">
            Have a specific request or need a custom transfer? Fill out the form
            below.
          </p>
        </div>
        ...
        <form
          ...
          className="bg-neutral-900 p-8 sm:p-10 rounded-3xl shadow-2xl border border-white/10 max-w-2xl mx-auto"
        >
          ...
          {status === "error" && (
            <div className="mt-4 p-4 bg-red-50 text-red-700 rounded-xl flex items-center gap-2 text-sm font-medium">
              ...
              Failed to send message. Please try WhatsApp or direct email
              instead.
            </div>
          )}
        </form>
